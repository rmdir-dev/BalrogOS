...
/*
source : https://wiki.osdev.org/ATA_PIO_Mode#Floating_Bus

avoid wait_while_busy on non existing devices.
*/
#define ATA_FLOATING_BUS 0xFF

/*
How many times we read the status register before giving up.
*/
