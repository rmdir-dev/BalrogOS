...
/*
Kernel heap start at KERNEL_OFFSET + 0x1000000000 (64GiB)
Total kernel heap = 512 GiB - 64GiB = 448
*/

#define KERNEL_VIRTUAL_START    0xffffff9000000000
...
void init_vmheap()
{
    ...
    block.free_blocks.next_free = KERNEL_VIRTUAL_START;
